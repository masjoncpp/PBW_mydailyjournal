                ...
                <td>
                    ...
                    if ($row["foto"] != '') {
                        if (file_exists('img/' . $row["foto"] . '')) {
                            ?>
                            <img src="img/<?= $row["foto"] ?>" width="60" class="rounded-circle">
                            <?php
                        } else {
                            ?>
                                    ...
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="username"
                                                placeholder="Tuliskan Username" value="<?= $row["user"] ?>" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="formGroupExampleInput2" class="form-label">Password Baru (Kosongkan
                                                jika tidak ingin diubah)</label>
                                        ...
                                        <div class="mb-3">
                                            <label for="formGroupExampleInput4" class="form-label">Foto Lama</label>
                                            <?php
                                            if ($row["foto"] != '') {
                                                if (file_exists('img/' . $row["foto"] . '')) {
                                                    ?>
                                                    <br><img src="img/<?= $row["foto"] ?>" width="60" class="rounded-circle">
                                                    <?php
                                                } else {
                                                    ?>
                                                    <br><i class="bi bi-person-circle fs-1"></i>
                                                    <?php
                                                }
                                            } else {
                                                ?>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form method="post" action="" enctype="multipart/form-data">
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            <label for="formGroupExampleInput" class="form-label">Yakin akan menghapus user
                                                "<strong>
                                                    <?= $row["user"] ?>
                                                </strong>"?</label>
                                            <input type="hidden" name="id" value="<?= $row["id"] ?>">
